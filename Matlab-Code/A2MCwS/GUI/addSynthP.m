function varargout = addSynthP(varargin)

gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @addSynthP_OpeningFcn, ...
                   'gui_OutputFcn',  @addSynthP_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
function addSynthP_OpeningFcn(hObject, eventdata, handles, varargin)
...
function varargout = addSynthP_OutputFcn(hObject, eventdata, handles) 
...
if (get(handles.togglebutton1,'value'))==0
    ...
    wavef3=get(get(handles.uipanel3,'SelectedObject'),'string');
    x1=str2func(wavef1);
    x2=str2func(wavef2);
    x3=str2func(wavef3);
    for i=1:length(M(:,1))
