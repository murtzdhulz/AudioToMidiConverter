function varargout = fmSynthP(varargin)

gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @fmSynthP_OpeningFcn, ...
                   'gui_OutputFcn',  @fmSynthP_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
function fmSynthP_OpeningFcn(hObject, eventdata, handles, varargin)
...
function varargout = fmSynthP_OutputFcn(hObject, eventdata, handles) 
